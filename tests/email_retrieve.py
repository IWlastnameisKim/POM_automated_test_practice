...
messages = messages[0].split() # 의미 없음
recent = all_email[-1:] # 마지막 메일


for n, message in enumerate(recent) : #recent 를 all_email로 변경하면 모든 메일에 대해서 메읽 읽기 수행함
